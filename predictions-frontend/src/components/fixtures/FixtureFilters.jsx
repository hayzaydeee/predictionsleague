        ...
        <div className="flex items-center justify-between gap-2 flex-wrap sm:flex-nowrap">
          ...
          <div className={`flex ${gaps.tight} flex-wrap flex-1`}>
            {filterOptions.map((option) => (
              <button
                ...
                className={`px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-lg text-2xs sm:text-xs font-medium transition-all duration-200 min-h-[44px] sm:min-h-0 ${
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            <button
              ...
              className={`flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-lg text-xs sm:text-sm font-medium transition-colors min-h-[44px] sm:min-h-0 ${
                theme === "dark"
            ...
            {hasActiveFilters && (
              <button
                ...
                className={`px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-lg text-2xs sm:text-xs font-medium transition-colors min-h-[44px] sm:min-h-0 ${
                  theme === "dark"
