  ...
  return (
    ...
    >
      <motion.div
        ...
        className="bg-slate-900 rounded-2xl max-w-5xl w-full max-h-[90vh] overflow-hidden shadow-2xl border border-slate-700/60"
      >
        {/* Header */}
        <div className="bg-slate-900 p-6 border-b border-slate-700/60">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={onClose}
              className="w-8 h-8 rounded-lg bg-slate-800/50 hover:bg-slate-700/50 flex items-center justify-center transition-all duration-200 text-slate-400 hover:text-slate-300"
            >
              ✕
            </button>
          </div>
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
          {/* Introduction */}
          <div className="bg-slate-800/50 border-slate-700/60 rounded-xl p-5 mb-6 border">
            <p className="text-slate-300 text-sm leading-relaxed font-outfit">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700/60">
              <div className="flex items-center gap-2 mb-6">
                <RocketIcon className="w-5 h-5 text-emerald-400" />
                <h4 className="text-slate-100 text-xl font-bold font-outfit">
                  Match Chips
                </h4>
                <div className="flex-1 h-px bg-slate-700/50"></div>
                <span className="text-slate-400 text-sm font-outfit">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <motion.div
                  ...
                  className="bg-slate-800/50 border-slate-700/60 hover:border-emerald-500/30 rounded-lg p-5 border transition-all duration-200"
                >
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h5 className="text-slate-100 text-lg font-semibold font-outfit">
                        Double Down
                      </h5>
                ...
                <motion.div
                  whileHover={{ scale: 1.02 }}
                  className="bg-slate-800/50 border-slate-700/60 hover:border-purple-500/30 rounded-lg p-5 border transition-all duration-200"
                >
                  <div className="flex items-center gap-3 mb-4">
                ...
                <motion.div
                  whileHover={{ scale: 1.02 }}
                  className="bg-slate-800/50 border-slate-700/60 hover:border-sky-500/30 rounded-lg p-5 border transition-all duration-200"
                >
                  <div className="flex items-center gap-3 mb-4">
                ...
                <motion.div
                  whileHover={{ scale: 1.02 }}
                  className="bg-slate-800/50 border-slate-700/60 hover:border-yellow-500/30 rounded-lg p-5 border transition-all duration-200"
                >
                  <div className="flex items-center gap-3 mb-4">
            ...
            <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700/60">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <motion.div
                  whileHover={{ scale: 1.02 }}
                  className="bg-slate-800/50 border-slate-700/60 hover:border-blue-500/30 rounded-lg p-5 border transition-all duration-200"
                >
                  <div className="flex items-center gap-3 mb-4">
                ...
                <motion.div
                  whileHover={{ scale: 1.02 }}
                  className="bg-slate-800/50 border-slate-700/60 hover:border-red-500/30 rounded-lg p-5 border transition-all duration-200"
                >
                  <div className="flex items-center gap-3 mb-4">
            ...
            <div className="bg-slate-800/50 border-slate-700/60 rounded-xl p-6 border">
              <div className="flex items-start gap-3 mb-6">
                ...
                <h4 className="text-emerald-300 text-lg font-semibold font-outfit">
                  Chip Management Guidelines
                </h4>
              </div>
