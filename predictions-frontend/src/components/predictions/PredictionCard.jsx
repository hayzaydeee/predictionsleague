...
const PredictionCard = ({
  ...
  return (
    ...
    >
        ...
        <div className="text-right ml-3">
          {prediction.points !== null && prediction.points !== undefined ? (
            <div className="flex items-baseline gap-1">
              <span className={`${isCompact ? "text-lg" : "text-xl"} font-bold ${
            ...
            <div className={`${isCompact ? "text-lg" : "text-xl"} font-bold font-outfit ${
      ...
      {/* Score Prediction */}
      <div className={`${isCompact ? "p-3" : "p-4"} rounded-lg mb-4 ${
        theme === "dark"
        ...
        <div className="mb-4">
          {!isCompact ? (
            ...
            <div>
              ...
              >
                {showGoalscorers ? <ChevronUpIcon className="w-3 h-3" /> : <ChevronDownIcon className="w-3 h-3" />}
                Show Goalscorers
              </button>
              {showGoalscorers && (
                <div className="space-y-2 pl-4">
                  {prediction.homeScorers?.length > 0 && (
                    <div className="text-xs">
                      ...
                      <span className={`ml-1 ${theme === "dark" ? "text-slate-300" : "text-slate-700"}`}>
        ...
        <div className={`border-t pt-3 ${
          ...
          {!isCompact ? (
            ...
            <>
              ...
              >
                {showChips ? <ChevronUpIcon className="w-3 h-3" /> : <ChevronDownIcon className="w-3 h-3" />}
                ...
                <div className="pl-4">
                  <div className="text-xs">
                    <span className={`${theme === "dark" ? "text-slate-300" : "text-slate-700"}`}>
                      {prediction.chips.map(chip => chip.replace('_', ' ')).join(", ")}
                    </span>
                  </div>
                </div>
              )}
